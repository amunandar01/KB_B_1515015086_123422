...
domains
tgl = integer %membuat tgl menjadi format angka panjang (long)
...
nondeterm 
status_usia(integer,symbol) %nondeterm pada section predicates berfungsi untuk memberi
				      % tahu compiler bahwa predikat tersebut mempunyai lebih dari satu jawaban kemungkinan.
